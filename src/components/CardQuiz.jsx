...
function CardQuiz({ nombre, descripcion, estado }) {
    return (
        <div className="flex flex-row items-center w-full max-w-3xl p-6 bg-white rounded-lg shadow-md border border-gray-200">
            <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-900 mb-2">{nombre}</h2>
